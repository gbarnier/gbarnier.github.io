...
<p class="paragraph">
The <b>take-away message</b> here is that migration is simply the process of using the reflected energy present in the recorded signal and determining the depth of the rock interface that generated this reflection. <br/><br/>
