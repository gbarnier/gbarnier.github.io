...
This is the official name of my thesis. It sounds fancy, but the concept is quite simple: the goal is to <b>improve the velocity model building process when the initial guess is not accurate enough</b> for conventional methods to work.
...
<h6 style="color: blue">(1) A new problem formulation</h6>
