...
<figure>
<img src="/images/data.png" class="fig" style="margin-left: 50px; width: 600px"/>
<figcaption class="fig-label" style="margin-left: -50px">Example of offshore seismic data</figcaption>
</figure>
